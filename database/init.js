...
module.exports.reviewsCollectionInit = async () => {
  ...
  const result = await Review.listIndexes();
  console.log(result);
};

module.exports.revsPhotosInit = () => {
...
module.exports.charCollectionInit = () => {
...
module.exports.productToReviewsInit = () => {
  const reviewsSchema = new mongoose.Schema({
    id: Number,
    product_id: Number,
    rating: Number,
...
module.exports.reviewToPhotosInit = () => {
  const reviewsPhotosSchema = new mongoose.Schema({
    id: Number,
    review_id: Number,
    url: String,
...
module.exports.productToCharacteristicsInit = () => {
  const characteristicsSchema = new mongoose.Schema({
    id: Number,
    product_id: Number,
    name: String,
...
module.exports.reviewToCharacteristicReviewsInit = () => {
  const characteristicReviewsSchema = new mongoose.Schema({
    id: Number,
    review_id: Number,
    characteristic_id: Number,
...
module.exports.characteristicToCharacteristicReviewsInit = () => {
  const characteristicsSchema = new mongoose.Schema({
    id: Number,
    product_id: Number,
    name: String,
